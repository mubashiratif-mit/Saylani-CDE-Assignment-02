...
-- Write your query below:
SELECT CONCAT(first_name, ' ', last_name), order_id, order_date
...
SELECT 
    CONCAT(s.full_name, ' ', s.last_name) AS staff_name,
    CONCAT(m.full_name, ' ', m.last_name) AS manager_name
